...
<div class="container">
	<nav class="navbar navbar-default">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="#">Tayyiba Cash & Carry Cart</a>
	    </div>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					<?php
						...
						$sql = "SELECT * FROM items WHERE id IN (".implode(',',$_SESSION['cart']).")";
			...
			<a href="payment" class="btn btn-success"><span class="glyphicon glyphicon-check"></span>Confirm</a>
			</form>
		</div>
	</div>
</div>
